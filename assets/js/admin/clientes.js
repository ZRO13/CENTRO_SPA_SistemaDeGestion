...
// Comportamiento de interfaz del CRUD de Clientes.
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggleForm() {
        ...
        btnText.textContent = oculto ? 'Nuevo Cliente' : 'Ocultar Formulario';
    }
    ...
    // Restricción para Nombre/Apellido: solo letras, espacios, acentos y la eñe
    ...
    // Restricción para Celular: solo dígitos
    if (inputCelular) {
    ...
    formulario.addEventListener('submit', function (e) {
        ...
        if (inputCelular) {
            ...
            if (!telRegex.test(inputCelular.value.trim())) {
                mostrarError(inputCelular, 'El celular debe contener entre 9 y 10 dígitos numéricos.');
                tieneErrores = true;
            }
        }
